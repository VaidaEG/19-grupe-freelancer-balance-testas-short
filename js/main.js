...
function sortData(list) {
    ...
    //Išrykiuoja menesiu sarasa nuo maziausio iki didziausio
    // sortedList = list.sort((a, b) => a.month - b.month);

    // Taip surandamas mažiausias menesio numeris sarase
    ...
    // Išrikiuoja menesiu sarasa nuo maziausio iki didziausio
    for (let i = 1; i <= 12; i++) {
